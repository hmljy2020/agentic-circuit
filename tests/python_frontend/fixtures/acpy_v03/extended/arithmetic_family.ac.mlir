builtin.module attributes {ac.contract_epoch = "0.3"} {
  ...
  ac.module @arithmetic_family() parameters {} graph {
    %q0 = ac.source "b0" : !ac.queue<!ac.struct<@types::@Operands>, #ac.queue_contract<depth = 1, latency = 1, rate = 1, domain = @core, ordering = fifo>>
    %q1 = ac.compute %q0 {
    ^bb0(%v0: !ac.var<!ac.struct<@types::@Operands>>):
      %v1 = ac.var.get %v0 ["left"] : (!ac.var<!ac.struct<@types::@Operands>>) -> !ac.var<i16>
      %v2 = ac.var.get %v0 ["right"] : (!ac.var<!ac.struct<@types::@Operands>>) -> !ac.var<i16>
      %v3 = ac.var.binary "add" %v1, %v2 : (!ac.var<i16>) -> !ac.var<i16> rhs !ac.var<i16>
      %v4 = ac.var.get %v0 ["left"] : (!ac.var<!ac.struct<@types::@Operands>>) -> !ac.var<i16>
      %v5 = ac.var.get %v0 ["right"] : (!ac.var<!ac.struct<@types::@Operands>>) -> !ac.var<i16>
      %v6 = ac.var.binary "sub" %v4, %v5 : (!ac.var<i16>) -> !ac.var<i16> rhs !ac.var<i16>
      %v7 = ac.var.get %v0 ["left"] : (!ac.var<!ac.struct<@types::@Operands>>) -> !ac.var<i16>
      %v8 = ac.var.get %v0 ["right"] : (!ac.var<!ac.struct<@types::@Operands>>) -> !ac.var<i16>
      %v9 = ac.var.binary "mul" %v7, %v8 : (!ac.var<i16>) -> !ac.var<i16> rhs !ac.var<i16>
      %v10 = ac.var.get %v0 ["left"] : (!ac.var<!ac.struct<@types::@Operands>>) -> !ac.var<i16>
      %v11 = ac.var.get %v0 ["mask"] : (!ac.var<!ac.struct<@types::@Operands>>) -> !ac.var<i16>
      %v12 = ac.var.binary "and" %v10, %v11 : (!ac.var<i16>) -> !ac.var<i16> rhs !ac.var<i16>
      %v13 = ac.var.get %v0 ["left"] : (!ac.var<!ac.struct<@types::@Operands>>) -> !ac.var<i16>
      %v14 = ac.var.get %v0 ["mask"] : (!ac.var<!ac.struct<@types::@Operands>>) -> !ac.var<i16>
      %v15 = ac.var.binary "or" %v13, %v14 : (!ac.var<i16>) -> !ac.var<i16> rhs !ac.var<i16>
      %v16 = ac.var.get %v0 ["left"] : (!ac.var<!ac.struct<@types::@Operands>>) -> !ac.var<i16>
      %v17 = ac.var.get %v0 ["mask"] : (!ac.var<!ac.struct<@types::@Operands>>) -> !ac.var<i16>
    ...
    } : (!ac.queue<!ac.struct<@types::@Operands>, #ac.queue_contract<depth = 1, latency = 1, rate = 1, domain = @core, ordering = fifo>>) -> !ac.queue<!ac.struct<@types::@Results>, #ac.queue_contract<depth = 1, latency = 1, rate = 1, domain = @core, ordering = fifo>>
    ac.observe %q1 as "b2" fields [] : !ac.queue<!ac.struct<@types::@Results>, #ac.queue_contract<depth = 1, latency = 1, rate = 1, domain = @core, ordering = fifo>>
    ac.return
  }
}
