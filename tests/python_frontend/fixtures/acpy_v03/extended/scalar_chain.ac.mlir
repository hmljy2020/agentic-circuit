builtin.module attributes {ac.contract_epoch = "0.3"} {
  ...
  ac.module @scalar_chain() parameters {} graph {
    %q0 = ac.source "b0" : !ac.queue<i16, #ac.queue_contract<depth = 1, latency = 1, rate = 1, domain = @core, ordering = fifo>>
    %q1 = ac.compute %q0 {
    ^bb0(%v0: !ac.var<i16>):
    ...
    ac.observe %q2 as "b3" fields [] : !ac.queue<i16, #ac.queue_contract<depth = 1, latency = 1, rate = 1, domain = @core, ordering = fifo>>
    ac.observe %q2 as "b4" fields [] : !ac.queue<i16, #ac.queue_contract<depth = 1, latency = 1, rate = 1, domain = @core, ordering = fifo>>
    ac.return
  }
}
