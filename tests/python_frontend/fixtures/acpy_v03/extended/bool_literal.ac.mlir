builtin.module attributes {ac.contract_epoch = "0.3"} {
  ...
  ac.module @bool_literal() parameters {} graph {
    %q0 = ac.v03.source "b0" : !ac.queue_v03<!ac.struct<@types::@Flag>, #ac.queue_contract<depth = 1, latency = 1, rate = 1, domain = @core, ordering = fifo>>
    %q1 = ac.compute %q0 {
    ...
    } : (!ac.queue_v03<!ac.struct<@types::@Flag>, #ac.queue_contract<depth = 1, latency = 1, rate = 1, domain = @core, ordering = fifo>>) -> !ac.queue_v03<!ac.struct<@types::@Flag>, #ac.queue_contract<depth = 1, latency = 1, rate = 1, domain = @core, ordering = fifo>>
    ac.v03.observe %q1 as "b2" fields [] : !ac.queue_v03<!ac.struct<@types::@Flag>, #ac.queue_contract<depth = 1, latency = 1, rate = 1, domain = @core, ordering = fifo>>
    ac.return
  }
}
