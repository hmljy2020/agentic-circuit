...
builtin.module attributes {ac.contract_epoch = "0.3"} {
  ...
  ac.module @m() parameters {} graph {
    ...
    ^bb0(%input: !ac.var<i16>):
      ...
      %value = ac.var.get %record field "value" : !ac.var<!ac.struct<@types::@Pair>> -> !ac.var<i16>
    ...
    ac.v03.observe %result as "result" fields [] : !ac.queue_v03<i16, #ac.queue_contract<depth = 1, latency = 1, rate = 1, domain = @core, ordering = fifo>>
    ac.return
  }
}
