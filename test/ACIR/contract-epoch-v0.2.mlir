...
// RUN: %acir_opt %t/valid-v03.mlir -o /dev/null
...
// LEGACY: expected top-level 'ac.contract_epoch' string attribute equal to "0.2" or "0.3"

//--- missing.mlir
module {
}

// MISSING: expected top-level 'ac.contract_epoch' string attribute equal to "0.2" or "0.3"
