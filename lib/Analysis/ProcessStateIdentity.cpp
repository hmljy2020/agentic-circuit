...
STR_GET(ProcessQueueTryTransferPayload, element, element)
STR_GET(ProcessQueueTryTransferPayload, source, source)
STR_GET(ProcessQueueTryTransferPayload, destination, destination)
STR_GET(ProcessQueuePeekPayload, element, element)
STR_GET(ProcessQueuePeekPayload, queue, queue)
STR_GET(ProcessQueueSpacePayload, queue, queue)
...
STR_GET(ProcessEventTryRecvPayload, element, element)
STR_GET(ProcessEventTryRecvPayload, eventQueue, eventQueue)
...
PAYLOAD_REF(ProcessQueueTryTransferPayload, queueTryTransfer, queueTryTransfer)
PAYLOAD_REF(ProcessQueuePeekPayload, queuePeek, queuePeek)
PAYLOAD_REF(ProcessQueueSpacePayload, queueSpace, queueSpace)
PAYLOAD_REF(ProcessEventSchedulePayload, eventSchedule, eventSchedule)
PAYLOAD_REF(ProcessEventTryRecvPayload, eventTryRecv, eventTryRecv)
