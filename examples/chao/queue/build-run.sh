...
# C API + model + 1 module + 2 processes.
if [[ ${#generated_objects[@]} -ne 5 ]]; then
...
/usr/bin/c++ -std=c++20 -I"${out_root}/include" \
  ...
  -L/usr/lib/llvm-22/lib -lLLVM -o "${out_root}/bin/queue-demo"

"${out_root}/bin/queue-demo"
